...
import styles from "../css/EngStudy.module.css";
...
function EngStudy() {
  ...
  const quiz_animal = [
    { answer: "SNAKE", img: "Q-1" },
    { answer: "PIGEON", img: "Q-2" },
    { answer: "HEDGEHOG", img: "Q-3" },
    { answer: "RABBIT", img: "Q-4" },
    { answer: "PANDA", img: "Q-5" },
  ]; // 동물 퀴즈 배열

  const quiz_exercise = [
    { answer: "WRESTLING", img: "Q-6" },
    { answer: "RUNNING", img: "Q-7" },
    { answer: "SKATE", img: "Q-8" },
    { answer: "TENNIS", img: "Q-9" },
    { answer: "RUGBY", img: "Q-10" },
  ]; // 운동 퀴즈 배열
  ...
  return (
    <div className={styles.quiz_main}>
      <div className={styles.quiz_btn_wrap}>
        <img
          id="quiz_0"
          src={require("../img/EngStudy/Quiz-1.png")}
          alt="동물퀴즈"
          style={{ top: "38%" }}
          onClick={startBtn}
        />
      ...
      <div className={styles.quiz_btn_wrap}>
        <img
          id="quiz_1"
          src={require("../img/EngStudy/Quiz-2.png")}
          alt="운동퀴즈"
          style={{ top: "38%" }}
          onClick={startBtn_1}
        />
